<template>
  <div class="max-w-md m-auto py-10 border-4 border-white">
    ...
    <ul class="list-reset mt-4">
      <!-- <div class="flex items-center justify-between flex-wrap">
        <div class="flex-1 flex justify-between flex-wrap pr-4">
          <div class="flex items-center">
            <svg version="1.1" class="fill-current text-indigo-lighter mr-3 flex items-center"
        ...
        xml:space="preserve">
            ...
            <p class="text-indigo-lighter font-semibold">コインを集める少年</p>
          </div>
        </div>
      ...
      <li class="py-4" v-for="quiz in quizzes" :key="quiz.id" :quiz="quiz">

        <div class="flex items-center justify-between flex-wrap">
          <div class="flex justify-between flex-wrap pr-4">
            <svg version="1.1" class="fill-current text-indigo-lighter mr-3 flex items-center" width="36.342px" height="36.342px" viewBox="0 0 569.342 569.342" style="enable-background:new 0 0 569.342 569.342;" xml:space="preserve">
              <g>
                <g>
                  <path d="M7.829,327.335c12.97-0.657,25.255-4.537,37.523-8.381c10.698-3.354,20.339-8.861,29.572-15.124
                    c8.213-5.569,15.765-11.738,20.828-20.575c3.635-6.345,7.715-12.437,11.718-18.564c0.571-0.873,2.093-2.052,2.672-1.823

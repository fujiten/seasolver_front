<template>
  <div class="max-w-md m-auto py-10">
    ...
    <h3 class="font-mono text-3xl text-indigo mb-4">問題一覧</h3>
      ...
      <div class="flex items-center justify-between flex-wrap">
        <div class="flex-1 flex justify-between flex-wrap pr-4">
          <div class="flex items-center">
            <svg version="1.1" class="fill-current text-indigo mr-3 flex items-center"
        ...
        xml:space="preserve">
            ...
            <p class="block font-semibold">コインを集める少年</p>
          </div>
        </div>
        <router-link to="/1" class="bg-transparent text-sm hover:bg-blue hover:text-white text-blue border border-blue no-underline font-bold py-2 px-4 mr-2 rounded">解いてみる</router-link>
     </div>

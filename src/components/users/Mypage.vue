        ...
        <div>
          ...
          <div>
            ...
            <transition name="list">
              <ul  v-show="openDropdown" class="float-right mr-1 border border-black inline-block">
                <li @click="jumpToEditUser" class="inlien-block bg-grey-lightest text-sm hover:bg-grey-light hover:text-grey-white text-grey-darkest border border-blue no-underline font-bold py-2 px-4 rounded">プロフィール編集</li>
                <li class="inlien-block bg-grey-lightest text-sm hover:bg-grey-light hover:text-grey-white text-grey-darkest border border-blue no-underline font-bold py-2 px-4 rounded text-center">詳細設定(準備中)</li>
              </ul>
            </transition>
          </div>
                ...
                <ul>
                  <li class="py-4" v-for="draftedQuiz in draftedQuizzes" :key="draftedQuiz.id">
                    <div class="flex items-center justify-between flex-wrap">
                      <div class="flex justify-between flex-wrap pr-4">
                        <svg version="1.1" class="fill-current text-indigo-lighter ml-3 mr-3 flex items-center" width="36.342px" height="36.342px" viewBox="0 0 569.342 569.342" style="enable-background:new 0 0 569.342 569.342;" xml:space="preserve">
                          <g>
                            <g>
...
export default {
  ...
  computed: {
    ...
    draftedQuizzesList () {
      console.log(this.draftedQuizzes.title[0])
      return this.draftedQuizzes.title[0]
    }
  },
  methods: {
    setError (error, text) {
